...
public class RecyclerViewDeletePostAdapter extends RecyclerView.Adapter<RecyclerViewDeletePostAdapter.ViewHolder>  {
        ...
        public ViewHolder(View view) {
            ...
            textViewUserName.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    RecyclerViewDeletePostAdapter.this.itemListner.showProfile(userId);
            ...
            buttonDeletePost.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    RecyclerViewDeletePostAdapter.this.itemListner.deletePostItem(postId);
    ...
    public RecyclerViewDeletePostAdapter(int resource) {
