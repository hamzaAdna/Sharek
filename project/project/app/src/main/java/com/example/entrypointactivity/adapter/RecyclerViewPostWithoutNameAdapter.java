...
public class RecyclerViewPostWithoutNameAdapter extends RecyclerView.Adapter<RecyclerViewPostWithoutNameAdapter.ViewHolder>  {
    ...
    public RecyclerViewPostWithoutNameAdapter(int resource) {
