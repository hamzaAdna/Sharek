...
public class ShowAllPostViewModel extends ViewModel {
    ...
    public void getPostsJoinAddressJoinUser(){
        postApiService.getPostsJoinAddressJoinUser()
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(result-> {
